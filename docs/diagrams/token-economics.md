...
Traditional loads ALL available tools at startup. mcp-exec only loads what you use.

| Servers | Tools Available | Traditional | You Use | mcp-exec | Savings |
|---------|-----------------|-------------|---------|----------|---------|
