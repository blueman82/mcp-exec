    ...
    async def _check_processing_times(self, ops) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            recent_processed = [
                ...
                if r.decision_timestamp and r.decision_timestamp > last_24h
                and r.status in [ACCESS_REQUEST_STATUS['APPROVED'], ACCESS_REQUEST_STATUS['REJECTED']]
            ]
            
            if recent_processed:
                processing_times = [
                    r.decision_timestamp - r.request_timestamp 
            ...
            blocks = [
                {
                    ...
                    "text": {
                        "type": "plain_text",
                        "text": "🚨 Access Request System Alert"
                    }
                },
                {
                    "type": "section",
