...
class TestHandoverGenerator:
    ...
    @pytest.mark.asyncio
    async def test_no_active_channels_returns_success_with_zero_count(self, mock_container):
    ...
    @pytest.mark.asyncio
    async def test_channels_with_no_data_are_skipped(self, mock_container):
    ...
    @pytest.mark.asyncio
    async def test_feedback_channel_is_filtered_out(self, mock_container):
    ...
    @pytest.mark.asyncio
    async def test_access_request_channel_is_filtered_out(self, mock_container):
    ...
    @pytest.mark.asyncio
    async def test_handover_target_channel_is_filtered_out(self, mock_container):
    ...
    @pytest.mark.asyncio
    async def test_bot_not_member_returns_not_member_status(self, mock_container):
    ...
    @pytest.mark.asyncio
    async def test_successful_generation_posts_to_target_channel(self, mock_container):
    ...
    @pytest.mark.asyncio
    async def test_error_handling_returns_error_status(self, mock_container):
    ...
    @pytest.mark.asyncio
    async def test_channel_with_messages_but_no_jira_is_processed(self, mock_container):
    ...
    @pytest.mark.asyncio
    async def test_channel_with_jira_but_no_messages_is_processed(self, mock_container):
    ...
    @pytest.mark.asyncio
    async def test_openai_handler_called_with_correct_prompts(self, mock_container):
