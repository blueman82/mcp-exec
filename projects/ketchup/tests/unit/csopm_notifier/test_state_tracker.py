...
class TestCSOPMStateTrackerProtocolCompliance(unittest.TestCase):
    ...
    def test_has_increment_ping_count_method(self):
        """Test CSOPMStateTracker has increment_ping_count method."""
        from ketchup_csopm_notifier.services.state_tracker import CSOPMStateTracker

        self.assertTrue(hasattr(CSOPMStateTracker, "increment_ping_count"))
...
class TestCSOPMStateTrackerItemParsing(unittest.TestCase):
    ...
    def test_item_to_notification_record(self):
        ...
        self.assertEqual(result.ping_count, 2)
    ...
    def test_item_to_notification_record_defaults(self):
        ...
        self.assertEqual(result.ping_count, 0)
...
class TestCSOPMStateTrackerIncrementPingCount(unittest.IsolatedAsyncioTestCase):
    """Test increment_ping_count method."""
    ...
    async def test_increment_ping_count_success(self):
        ...
        result = await self.tracker.increment_ping_count("CSOPM-1234")

        self.assertIsNotNone(result)
        self.assertEqual(result.ping_count, 3)
    ...
    async def test_increment_ping_count_uses_atomic_increment(self):
        ...
        self.assertIn("ping_count = ping_count + :inc", update_expr)
...
class TestCSOPMStateTrackerHandleReassignment(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_handle_reassignment_resets_ping_count_to_one(self):
        ...
        self.assertEqual(expr_values[":ping_count"]["N"], "1")
...
class TestCSOPMStateTrackerDynamoDBTypeDescriptors(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_create_uses_proper_type_descriptors(self):
        ...
        self.assertIn("N", item["ping_count"])
