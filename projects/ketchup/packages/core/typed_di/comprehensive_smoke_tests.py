...
class ComprehensiveSmokeTester:
    ...
    async def test_all_registered_services(self) -> SmokeTestReport:
        ...
        logger.info(
            f"🔬 Smoke tests complete: {self.report.services_passed}/{self.report.services_tested} passed"
        )

        return self.report

    async def _test_service(self, registry, service_key: str) -> ServiceTestResult:
    ...
    async def _test_bridge_service(self, bridge, service_key: str) -> ServiceTestResult:
