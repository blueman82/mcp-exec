...
class KetchupSlackServiceProtocol(Protocol):
    ...
    async def update_message(
        self, channel: str, ts: str, text: str, blocks: List[Dict[str, Any]] = None
    ) -> Dict[str, Any]: ...
...
class SlackPostingHandlerProtocol(Protocol):
    ...
    async def post_message(
        self, channel: str, message: str, blocks: List[Dict[str, Any]] = None
    ) -> Dict[str, Any]: ...

    async def post_ephemeral(
        self, channel: str, user: str, message: str, blocks: List[Dict[str, Any]] = None
    ) -> Dict[str, Any]: ...

    async def update_message(
        self, channel: str, ts: str, message: str, blocks: List[Dict[str, Any]] = None
    ) -> Dict[str, Any]: ...
