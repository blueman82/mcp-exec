...
<body>
    ...
    <script nonce="${nonce}">
        (function() {
            ...
            let mcpPackages = { mcpExecInstalled: false, mcpExecVersion: null, mcpExecSource: null };
                ...
                let html = \`
                    <div class="setup-wizard">
                        ...
                        <div class="setup-section tools-section">
                            ...
                            <p class="section-desc">Add mcp-exec to your AI tools. Detected \${installedTools.length} tool(s), \${configuredCount} configured.</p>
            ...
            window.addEventListener('message', event => {
                ...
                switch (message.type) {
                    ...
                    case 'updateSetup':
                        ...
                        mcpPackages = message.mcpPackages || { mcpExecInstalled: false, mcpExecVersion: null, mcpExecSource: null };
                        document.getElementById('setup-loading').classList.add('hidden');
                        renderSetup();
                        break;
