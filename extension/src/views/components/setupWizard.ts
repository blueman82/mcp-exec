    ...
    return `
        <div class="tool-actions">
            <button class="btn btn-primary btn-auto-configure"
                    ...
                    title="Automatically add meta-mcp to this tool's config">
                🚀 Auto-Configure
            </button>
...
function renderConfiguredMessage(): string {
    return `
        <div class="tool-message success">
            ✓ meta-mcp is already configured for this tool
        </div>
    `;
}
    ...
    return `
        <div class="custom-path-section">
            <div class="section-header">
                ...
                <p class="section-desc">Add meta-mcp to a custom configuration file</p>
            </div>
    ...
    return `
        <div class="setup-wizard">
            <div class="wizard-header">
                <h2>🔧 Setup Wizard</h2>
                <p class="wizard-desc">Configure meta-mcp for your AI development tools</p>
            ...
            <div class="wizard-footer">
                ...
                <div class="wizard-docs">
                    ...
                    <a href="https://github.com/OneAdobe/meta-mcp-server#readme" class="docs-link" data-action="open-docs">
                        📖 View Documentation
                    </a>
                </div>
            </div>
