...
class TestGetMonthlyAggregates:
    ...
    async def test_quarterly_aggregation(self):
        ...
        with patch('packages.db.dynamodb_store.DynamoDBStore') as mock_store_class:
            ...
            mock_store.get_monthly_aggregates.return_value = {
                "2025_09": {"auto_status_posts": 10, "war_room_sent": 100, "war_room_success": 95, "war_room_failed": 5, "war_room_unique_users": 30},
                "2025_10": {"auto_status_posts": 15, "war_room_sent": 150, "war_room_success": 145, "war_room_failed": 5, "war_room_unique_users": 40},
                "2025_11": {"auto_status_posts": 20, "war_room_sent": 200, "war_room_success": 195, "war_room_failed": 5, "war_room_unique_users": 50},
            }
